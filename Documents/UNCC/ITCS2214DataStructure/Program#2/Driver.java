    ...
    public static void main(String[] args)
    {
        ...
        for(int i=0; i<60; i++)
        {
            if(rand.nextInt(4)==1)
            {
               ...
               System.out.println("New customer added!  Queue length is now: " + line.getsize());//notify new customer added
              if(line.getsize()>maxLine)//check if customer is maxinum in the 60 minute
              maxLine=line.getsize();//store only the maxinum of customer in the line within 60 minute
            ...
            System.out.println("Customer serviced and removed from the queue.  Quest length is now :" + line.getsize());
            }
            }
